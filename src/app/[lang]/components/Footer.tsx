...
export default function Footer(props: FooterProps) {
    try {
        ...
        return (
            <div className="relative bg-[#080808] border-t border-white/8">
                <div className="container mx-auto px-6 py-12">
                    <div
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <div className="max-w-md mt-4 text-white/40">
                                <p>
                            ...
                            <div className="flex flex-wrap w-full -mt-2 -ml-3 lg:ml-0">
                                {navigation.map((item, index) => (
                                    <Link
                                        key={index}
                                        href={item.href}
                                        className="w-full px-4 py-2 text-white/40 rounded-md hover:text-white transition-colors duration-150"
                                    >
                                        {item.name}
                                    </Link>
                                ))}
                        ...
                        <div className="">
                            <div className="text-white/50 text-sm">{props.dict.footer.followUs}</div>
                            <div className="flex mt-5 space-x-5 text-white/30 hover:[&>a]:text-white [&>a]:transition-colors [&>a]:duration-150">
                                <a
                    ...
                    <div className="my-10 text-sm text-center text-white/25">
                        Copyright © {new Date().getFullYear()}. All rights reserved. Schopi
                    </div>
                </div>
            </div>
        );
    ...
    return (
        <svg width="232" height="45" viewBox="0 0 232 45" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
                ...
                fill="rgba(255,255,255,0.7)"/>
            <path d="M225.172 9.8H227.836V35H225.172V9.8Z" fill="rgba(255,255,255,0.7)"/>
        </svg>
    );
}
