      ...
      {({ open }) => (
        <div className="flex flex-wrap items-center justify-between w-full lg:w-auto">
          ...
          <DisclosureButton
            ...
            className="px-2 py-1 ml-auto text-gray-500 rounded-md lg:hidden hover:text-schopiColor-primary focus:text-schopiColor-primary focus:bg-indigo-100 focus:outline-none dark:text-gray-300 dark:focus:bg-trueGray-700"
          >
            <svg
          ...
          <DisclosurePanel className="flex flex-wrap w-full my-5 lg:hidden">
            <>
              ...
              <Link
                ...
                className="w-full px-6 py-2 mt-3 text-center text-white bg-schopiColor-primary rounded-md lg:ml-5"
              >
                {cta.text}
              </Link>
            </>
