...
export default function TestimonialsRevamp({ dict, avatarUrls = [] }: TestimonialsRevampProps) {
  ...
  const testimonials = [
    {
      name: dict.testimonalSection.testimonials.testimonial1.name,
      role: dict.testimonalSection.testimonials.testimonial1.job,
      avatar: dict.testimonalSection.testimonials.testimonial1.name.split(" ").map((n: string) => n[0]).join(""),
      avatarUrl: avatarUrls[0],
      color: "bg-pink-500",
      rating: 5,
      comment: "Schopi sayesinde alışveriş listelerimi hızlıca oluşturabiliyorum. Ekip arkadaşlarımın önerileriyle alışveriş sürecimizi mükemmel bir şekilde organize ettik.",
      highlight: "alışveriş listelerimi",
    },
    {
      name: dict.testimonalSection.testimonials.testimonial2.name,
      role: dict.testimonalSection.testimonials.testimonial2.job,
      avatar: dict.testimonalSection.testimonials.testimonial2.name.split(" ").map((n: string) => n[0]).join(""),
      avatarUrl: avatarUrls[1],
      color: "bg-blue-500",
      rating: 5,
      comment: "Web ve mobil uygulamaların uyumu sayesinde, her zaman ve her yerde listelerime erişebiliyorum. Kullanıcı deneyimi gerçekten harika!",
      highlight: "her zaman ve her yerde",
    },
    {
      name: dict.testimonalSection.testimonials.testimonial3.name,
      role: dict.testimonalSection.testimonials.testimonial3.job,
      avatar: dict.testimonalSection.testimonials.testimonial3.name.split(" ").map((n: string) => n[0]).join(""),
      avatarUrl: avatarUrls[2],
      color: "bg-purple-500",
      rating: 5,
      comment: "Schopi, ailemle organize olmamı sağladı. Tatil alışverişlerimizi hiç bu kadar kolay yapmamıştık. Paylaşım özelliği harika!",
      highlight: "organize olmamı",
    },
    {
      name: "Can Arslan",
      ...
      rating: 5,
      comment: "Bütçe takip özelliği sayesinde aylık market harcamalarımı %30 azalttım. Artık kasada sürprizle karşılaşmıyorum.",
      highlight: "aylık market harcamalarımı",
    },
  ];
